...
![image-20201220213306128](/upload/images/20211212/image-20201220213306128.png)

![image-20201220214210994](/upload/images/20211212/image-20201220214210994.png)
...
![image-20201220222456675](/upload/images/20211212/image-20201220222456675.png)
...
![image-20200404111908085](/upload/images/20211212/image-20200404111908085-0291323.png)
...
![image-20200404120356784](/upload/images/20211212/image-20200404120356784.png)
...
# 10.数据卷(volum)实现与宿主机共享目录
	docker run -v 宿主机的路径|任意别名:/容器内的路径 镜像名
		注意: 
				...
				3.如果宿主机是windows,则映射目录例如`-v /d/max:/home/mnt` 其中/d/max表示d盘的max目录
...
![image-20200404142950068](/upload/images/20211212/image-20200404142950068.png)
...
![](/upload/images/20211212/1567585172(1).jpg)
...
- 启动出现如下错误
- ![image-20200602184321790](/upload/images/20211212/image-20200602184321790.png)
...
![image-20200602183429286](/upload/images/20211212/image-20200602183429286.png)
...
![image-20200602183718623](/upload/images/20211212/image-20200602183718623.png)
...
![image-20200404111908085](/upload/images/20211212/image-20200404111908085.png)

- **通过架构图可以看出通过DockerFile可以直接构建镜像**

### 9.2 Dockerfile解析过程

![image-20200603181253804](/upload/images/20211212/image-20200603181253804.png)
...
![image-20200605172151266](/upload/images/20211212/image-20200605172151266.png)

##### 2.将可运行项目放入linux虚拟机中

![image-20200605172340380](/upload/images/20211212/image-20200605172340380.png)
...
![image-20200605173141636](/upload/images/20211212/image-20200605173141636.png)
...
![image-20201125105847896](/upload/images/20211212/image-20201125105847896.png)
...
![image-20201223231707738](/upload/images/20211212/image-20201223231707738.png)
...
你也可以直接复制到容器
```
docker cp /etc/apt/sources.list 容器id:/etc/apt/sources.list
```
...
![容器管理之--容器管理](https://s1.51cto.com/images/blog/201908/19/4c632d8989142643d5f03acf3adbd0dd.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
这样是交互式显示，不易来监控指标
\#docker stats --help
\#docker stats --no stream nginx-v1
![容器管理之--容器管理](https://s1.51cto.com/images/blog/201908/19/418920b378e2821d56001207834c6c5e.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
